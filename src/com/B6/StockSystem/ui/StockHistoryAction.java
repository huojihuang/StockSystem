...
/**
 * 处理前端页面，所有关于StockHistory信息的请求
 * @author Nike
 *@version2015年5月10日 下午4:46:31
 */
@Controller("stockHistoryAction")
public class StockHistoryAction extends ActionSupport implements ServletRequestAware{
	private static final long serialVersionUID = 1L;
	private static final Logger log = Logger.getLogger(UserAction.class);
	private HttpServletRequest request;
	private boolean judge;
	@Resource
	IStockHistoryService stockHistoryServiceImpl;
